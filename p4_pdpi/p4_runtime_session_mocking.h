...
#ifndef P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_MOCKING_H_
#define P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_MOCKING_H_
...
struct P4SessionWithMockStub {
  ...
  p4::v1::grpc::MockP4RuntimeStub& mock_p4rt_stub;
};
...
void SetNextReadResponse(p4::v1::grpc::MockP4RuntimeStub& mock_p4rt_stub,
...
void SetDefaultReadResponse(p4::v1::grpc::MockP4RuntimeStub& mock_p4rt_stub,
                            std::vector<p4::v1::Entity> read_entities);
...
void MockP4RuntimeSessionCreate(p4::v1::grpc::MockP4RuntimeStub& stub,
                                const P4RuntimeSessionOptionalArgs& metadata);
...
void MockCheckNoEntities(p4::v1::grpc::MockP4RuntimeStub& stub,
...
// remaining.
void MockClearEntities(p4::v1::grpc::MockP4RuntimeStub& stub,
                       const p4::config::v1::P4Info& p4info,
                       const P4RuntimeSessionOptionalArgs& metadata);
...
void MockCheckNoEntries(p4::v1::grpc::MockP4RuntimeStub& stub,
                        std::optional<p4::config::v1::P4Info> p4info);
...
ABSL_DEPRECATED(
    ...
    "everywhere. See b/293888656 for more information.")
void MockClearTableEntries(p4::v1::grpc::MockP4RuntimeStub& stub,
                           const p4::config::v1::P4Info& p4info,
                           const P4RuntimeSessionOptionalArgs& metadata);

}  // namespace pdpi

#endif  // P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_MOCKING_H_
