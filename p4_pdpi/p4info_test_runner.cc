...
static void RunP4InfoTest(const std::string& test_name, const P4Info& p4info) {
  std::cout << pdpi::TestHeader(test_name) << std::endl << std::endl;
...
int main(int argc, char** argv) {
  ...
  pdpi::RunP4InfoTest(
      ...
      gutil::ParseProtoOrDie<pdpi::P4Info>(
          R"pb(tables {
  ...
  pdpi::RunP4InfoTest("duplicate table id",
                      gutil::ParseProtoOrDie<pdpi::P4Info>(
                          R"pb(tables {
                                 preamble {
                                   id: 1
  ...
  pdpi::RunP4InfoTest("duplicate table name",
                      gutil::ParseProtoOrDie<pdpi::P4Info>(
                          R"pb(tables {
                                 preamble {
                                   id: 1
  ...
  pdpi::RunP4InfoTest(
      "duplicate param name", gutil::ParseProtoOrDie<pdpi::P4Info>(R"pb(
        actions {
          preamble { id: 1 name: "do_thing_1" alias: "do_thing_1" }
          params { id: 1 name: "param1" }
  ...
  pdpi::RunP4InfoTest(
      "invalid format annotation", gutil::ParseProtoOrDie<pdpi::P4Info>(R"pb(
        actions {
          preamble { id: 1 name: "do_thing_1" alias: "do_thing_1" }
          params { id: 1 name: "param1" }
  ...
  pdpi::RunP4InfoTest("main.p4", p4info);
