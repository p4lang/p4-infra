...
#ifndef P4_INFRA_P4_PDPI_SEQUENCING_UTIL_H_
#define P4_INFRA_P4_PDPI_SEQUENCING_UTIL_H_
...
// TODO(b/283152941) rename this file to reachability_util.h once reachability
// analysis replaces p4 sequencing.
namespace pdpi {

struct ReferenceRelationKey {
  // TODO(b/281589685) Add referring table id to handle cases where two or
...
#endif  // P4_INFRA_P4_PDPI_SEQUENCING_UTIL_H_
