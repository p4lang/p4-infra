...
#ifndef P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_H_
#define P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_H_
...
#include "third_party/pins_infra/sai_p4/fixed/roles.h"
...
class P4RuntimeSession {
 ...
 private:
  ...
  std::unique_ptr<p4::v1::grpc::P4Runtime::StubInterface> stub_;
...
#endif  // P4_INFRA_P4_PDPI_P4_RUNTIME_SESSION_H_
