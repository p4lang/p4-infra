...
#ifndef P4_INFRA_STRING_ENCODINGS_READABLE_BIT_STRING_H_
#define P4_INFRA_STRING_ENCODINGS_READABLE_BIT_STRING_H_
...
#endif  // P4_INFRA_STRING_ENCODINGS_READABLE_BIT_STRING_H_
